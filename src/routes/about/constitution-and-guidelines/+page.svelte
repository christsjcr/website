...
<PageHeader
    ...
    <Content>
        <h2>📜 Constitution</h2>
        <p>
            The JCR is guided by a Constitution which dictates the composition
        ...
        <p>
            ...
            publishing and distributing termly expenditure reports.
        </p>
        <p>
            The JCR has to conform to this document, so it's accessible here for
            all students to read!
        </p>
        <h4>
            <a href="/doc/financial-conduct.pdf" download>Download</a>
        </h4>
        <h2>⛹️ Society Funding Guidelines</h2>
        <p>
            Christ's JCR funds sports clubs and non-sports clubs in accordance
            ...
            a fair overall budget.
        </p>
        <h4>
            <a href="/doc/funding-guidelines.pdf" download>Download</a>
        </h4>
    </Content>
</PageHeader>
